...
function MenubarItem({
  ...
  return (
    <DropdownMenuItem
      ...
      className={cn("focus:bg-accent focus:text-accent-foreground data-[variant=danger]:text-danger data-[variant=danger]:focus:bg-danger/10 dark:data-[variant=danger]:focus:bg-danger/20 data-[variant=danger]:focus:text-danger data-[variant=danger]:*:[svg]:!text-danger not-data-[variant=danger]:focus:**:text-accent-foreground gap-1.5 rounded-md px-1.5 py-1 text-sm data-[disabled]:opacity-50 data-[inset]:pl-8 [&_svg:not([class*='size-'])]:size-4 group/menubar-item", className)}
      {...props}
    />
  )
}
